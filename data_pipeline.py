...
def clean_and_align():
    ...
    NEW_DATA_DIR = Path(__file__).resolve().parent / "new_data"
...
def feature_engineering():
    ...
    #路径配置
    INPUT_FILE = Path(__file__).resolve().parent / "new_data" / "merged_clean.csv"
    OUTPUT_FILE = Path(__file__).resolve().parent / "new_data" / "features.csv"
